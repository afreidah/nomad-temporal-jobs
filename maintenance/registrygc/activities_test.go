...
//
// Tests pure helpers (blob-line parser) and config defaults. Activities that
// touch the Nomad API or SSH are exercised via the workflow test suite with
// mocks rather than directly here.
// -------------------------------------------------------------------------------
