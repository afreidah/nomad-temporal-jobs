...
func TestPostgresMaintenance_Success(t *testing.T) {
	...
	env.ExecuteWorkflow(PostgresMaintenance, PostgresMaintenanceConfig{Concurrency: 2})
	...
	var result PostgresMaintenanceResult
...
func TestPostgresMaintenance_Defaults(t *testing.T) {
	...
	env.ExecuteWorkflow(PostgresMaintenance, PostgresMaintenanceConfig{})
