...
// Activities holds the Postgres dependency for the maintenance activities.
// Register an instance with the Temporal worker to expose ListPostgresDatabases
// and VacuumAnalyzeDatabase as activity implementations.
type Activities struct {
	pg pgMaintainer
}

// New creates an Activities instance over the shared Postgres client.
func New(pg pgMaintainer) *Activities {
	return &Activities{pg: pg}
}
