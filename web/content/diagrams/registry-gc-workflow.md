...
(function() {
  var diagramSrc = [
    'flowchart TD',
    '    START([RegistryGC<br/>Workflow]):::workflow --> DEFAULTS[Apply Config<br/>Defaults]:::workflow',
    '    DEFAULTS --> FIND[Find Registry<br/>Node]:::activity',
    '    FIND --> MEASURE1[Measure Data Dir<br/>before]:::activity',
    '    MEASURE1 --> SCALE0[Scale Registry<br/>to 0]:::activity',
    ...
    '    DRAIN --> GC[Run Garbage-<br/>Collect Docker API]:::activity',
    '    GC --> MEASURE2[Measure Data Dir<br/>after]:::activity',
