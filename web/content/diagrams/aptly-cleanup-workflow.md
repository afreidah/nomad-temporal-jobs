...
(function() {
  var diagramSrc = [
    'flowchart TD',
    '    START([AptlyCleanup<br/>Workflow]):::workflow --> DEFAULTS[Apply Config<br/>Defaults]:::workflow',
    '    DEFAULTS --> FIND[Find Aptly<br/>Node]:::activity',
    '    FIND --> MEASURE1[Measure Data Dir<br/>before]:::activity',
    '    MEASURE1 --> SCALE0[Scale Aptly<br/>to 0]:::activity',
    '    SCALE0 --> SGATE{Scale-down<br/>OK?}:::decision',
    '    SGATE -->|no| ABORT[Return Error<br/>no compensation]:::error',
    '    SGATE -->|yes| DEFER[Register Deferred<br/>Scale-Back]:::compensation',
    '    DEFER --> DRAIN[Wait Allocs<br/>Drained]:::activity',
    '    DRAIN --> CLEAN[Run aptly db cleanup<br/>Docker API]:::activity',
    '    CLEAN --> MEASURE2[Measure Data Dir<br/>after]:::activity',
    '    MEASURE2 --> REPORT[Compute Bytes<br/>Reclaimed]:::workflow',
    '    REPORT --> COMP',
    '    DRAIN -.->|failure| COMP',
    '    CLEAN -.->|failure / timeout / cancel| COMP',
    '    COMP[Compensation:<br/>Scale Back to 1]:::compensation --> WAITRUN[Wait Alloc<br/>Running]:::activity',
    '    WAITRUN --> CGATE{Scale-back<br/>OK?}:::decision',
    '    CGATE -->|no| CRIT[Log CRITICAL<br/>manual recovery]:::error',
    '    CGATE -->|yes| DONE',
    '    CRIT --> DONE([Workflow<br/>Complete]):::workflow',
    '',
