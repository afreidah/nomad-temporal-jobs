...
(function() {
  var diagramSrc = [
    'flowchart TD',
    '    START([Backup<br/>Workflow]):::workflow --> DEFAULTS[Apply Config<br/>Defaults]:::workflow',
    '    DEFAULTS --> NOMAD_SNAP[Take Nomad<br/>Snapshot]:::activity',
    '    DEFAULTS --> CONSUL_SNAP[Take Consul<br/>Snapshot]:::activity',
    '    DEFAULTS --> PG_GLOBALS[Dump Postgres<br/>Globals]:::activity',
    '    NOMAD_SNAP --> NOMAD_S3{Upload to<br/>S3?}:::decision',
    '    NOMAD_S3 -->|non-fatal| JOIN',
    '    CONSUL_SNAP --> CONSUL_S3{Upload to<br/>S3?}:::decision',
    '    CONSUL_S3 -->|non-fatal| JOIN',
    '    PG_GLOBALS --> PG_GLOBALS_S3{Upload to<br/>S3?}:::decision',
    '    PG_GLOBALS_S3 -->|non-fatal| PG_LIST[List<br/>Databases]:::activity',
    '    PG_LIST --> PG_DUMP[Dump Each DB<br/>bounded concurrency]:::activity',
